...
class Texts(metaclass=MetaClass):
    ...
    disabled_for_new_users = "Извините, на данный момент отключена регистрация новых пользователей"
    ...
    image_successfully_gotten = (
        "Чек принят и отправлен на модерацию, скоро я пришлю вам уникальный код на скидку"
    )
    image_already_sent = "Данный чек уже был отправлен на модерацию"
    sorry_gift_codes_ended = "Извините, все коды-призы уже разобраны, скоро мы загрузим новые"
    check_resolve_success_1 = (
        "Ваш чек успешно прошел модерацию, вот ваш уникальный приз типа 1: {code}"
    )
